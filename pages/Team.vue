      ...
      meta: [
        {
          ...
          name: "ourteam",
          content:
            "East Coast Cricket Club (ECCC) was formed as a result of restructure within the Halifax Cricket League (HCL), which is governed by the Nova Scotia Cricket Association (NSCA). We are very proud to present our team."
        },
        {
          hid: `og:image`,
          property: 'og:image',
          content: this.teamData.heroImage.url
        }
      ]
    };
  }
